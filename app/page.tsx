...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isLogin && (email !== "demo@moneta.com" || password !== "demo123")) {
      setError("Email ou senha inválida. Tente demo@moneta.com / demo123")
      return
    }
        ...
        <CardContent className="pt-8 pb-8 px-8">
          ...
          <div className="mt-6 text-center">
            ...
            >
              ...
              <span className="text-primary font-semibold">{isLogin ? "Inscrever-se" : "Entrar"}</span>
            </button>
          </div>
        </CardContent>
      </Card>
